# This script finds wally on the image generated by 'find_wally_photo.py'.
...
label_map = label_map_util.load_labelmap('PATH_TO_LABELS/labels.txt')
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        image_np = load_image_into_array(Image.open(args.image_path))
